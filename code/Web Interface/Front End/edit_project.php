    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
		  ...
		  <!-- Display existing project's list-->
		  
            <h2>Settings</h2>
			<hr>
			<h3><a name="changepass">Edit existing Project's Information</a></h3>
			<br /><br /><br />
			    <form class="form-horizontal" action="edit_project2.php" method="post">
				<fieldset>
				
				Select the Project which you want to edit:
				<br /><br />
				...
				while($row=mysql_fetch_array($result)){
					$query1="Select * from settlement_info where set_id=".$row['PROJ_SETTLEMENT_ID'];
					$result1=mysql_query($query1);
					$row1 = mysql_fetch_array($result1);
		      		echo "<label class=\"radio\">";
					if($i==0){
			      	echo "<input type=\"radio\" checked name=\"proj\" id=".$row['PROJ_ID']." value=".$row['PROJ_ID'].">";
					}
					else{
					echo "<input type=\"radio\" name=\"proj\" id=".$row['PROJ_ID']." value=".$row['PROJ_ID'].">";
					}
				echo $row['PROJ_NAME']." in ".$row1['set_name'];
				echo "</label>";
				++$i;
				}
				?>
